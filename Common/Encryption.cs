...
namespace bfbd.Common
{
    ...
    public static class EncryptionExtension
    {
        ...
        public static byte[] SecureKey { get; set; } = Convert.FromBase64String("OXVu4Z2VT3mHgx9qb5kReA==");
        public static byte[] SecureVi { get; set;} = Convert.FromBase64String("1hdv+QZDqhI=");
